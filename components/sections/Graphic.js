...
function Graphic({ className, innerClassName, type, img, background, color, children }) {
  ...
  var allClasses = `section--graphic graphic ${backgroundClasses} ${className} ${hasButtonClasses}`;
    ...
    <>
      {isImg && (
        <div className={`graphic--img ${allClasses}`} style={{ "--img-aspect-width": img.width, "--img-aspect-height": img.height }}>
          <Image className={innerClassName} src={img.src} alt={img.alt} width={img.width} height={img.height} />
          {children && children}
        </div>
      )}
      {isMask && (
        <div className={`graphic--mask ${allClasses}`} style={{ "--mask-aspect-width": img.width, "--mask-aspect-height": img.height }}>
          <Mask className={`${innerClassName} ${color}`} src={img.src} alt={img.alt} width={img.width} height={img.height} />
          {children && children}
        </div>
      )}
    </>
