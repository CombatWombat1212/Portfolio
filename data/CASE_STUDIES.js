...
const CASE_STUDIES = caseStudiesInit([
  ...
  },
  {
    ...
    brief: {
      description:
        "Creative development thrives when kids get to try a wide breadth of mediums for self-expression.  We provide parents with a curated feed of unique activities, and locations for play.",
