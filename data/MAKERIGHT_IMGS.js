...
const MAKERIGHT_IMGS = processImages(
  {
    ...
    brainstorming_chart_full_expanded: {
      name: "brainstorming_chart_full_expanded",
      title: "Cost and Difficulty of 3D Printing Mindmap",
      src: "/assets/images/makeright/brainstorming_chart_full_expanded.svg",
      alt: "A large-scale mindmap surrounding the cost and difficulty of 3D printing",
      width: 1445.2,
      height: 1210,
    },
    ...
    maker_screen_01: {
      ...
      phase: "1/3",
      description: [
        "Each user journey begins at Login. Ideally, we will have a welcoming and informative homepage.  However, this was not within the project scope.",
      ],
    ...
    maker_screen_03: {
      ...
      notes: [
        "The maker overview explains critical information about the rules and responsibilities of a maker. Like a ‘Terms of Service’ but more visual, and actually helpful.",
      ],
    ...
    maker_screen_04: {
      ...
      phase: "1/1",
      description: [
        "Collect personal details for the user’s account, banking information to pay them for their work, and their weekly availability to determine when they will receive new orders.",
      ],
      actions: ["Fill out the provided forms and continue on."],
    ...
    maker_screen_08: {
      ...
      notes: [
        "The following test teaches users the order completion process by walking them through a mock order. The resulting printed object is then reviewed to gauge the user’s 3D printing skills. Thereby feeding 2 birds with 1 seed.",
      ],
    ...
    maker_screen_09: {
      ...
      section: "Maker test start",
      title: {
        xxl: "Orders (awaiting acceptance)",
        md: (
          <>
            Orders <Nobr>(awaiting acceptance)</Nobr>
          </>
        ),
      },
      phase: "2/3",
    ...
    maker_screen_10: {
      ...
      phase: "3/3",
      description: [
        "Provide the details of particular job order: the user’s chosen specifications, object info, a preview of the model, order timeline, and additional comments left by your customer.",
      ],
    ...
    maker_screen_12: {
      ...
      phase: "2/2",
      description: [
        "Allow the user to download the file, and check to ensure that it is able to be printed via slicing software. This ensures makers are never expected to print a file that cannot be printed, and that they never have to modify models.",
      ],
      ...
      actions: [
        "Review the steps and guidelines if needed, download the attached file, open it in their slicing software, and assess",
        "Select the result of their vetting process, and submit.",
      ],
      notes: [],
    ...
    maker_screen_14: {
      ...
      phase: "2/2",
      description: [
        "Submit 4 images of the printed object to the customer. This gives the customer peace of mind that the print was totally successful, or the opportunity to intervene and request a reprint if something looks wrong.",
      ],
    ...
    maker_screen_15: {
      ...
      phase: "1/3",
      description: [
        "Remind the maker that their order has been submitted, and it’s time to wait for the customer’s response. Ensuring the customer is satisfied and won't be surprised by the product that arrives on their doorstep.",
      ],
      actions: [
        "Wait for the customer’s approval, prepare to ship the object if they want to, and view their submission if they want to double-check what they’ve delivered. ",
      ],
      notes: [],
