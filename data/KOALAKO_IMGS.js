...
const KOALAKO_IMGS = processImages(
  {
    ...
    solution_inspire: {
      name: "solution_inspire",
      src: "./assets/images/koalako/illustrations/solution_inspire.svg",
      alt: "An illustrated graphic of a brain",
      width: 88.86,
      height: 65.87,
    },
    testing_popcorn: {
    ...
    refine_trophies: {
      name: "refine_trophies",
      src: "/assets/images/koalako/refine/refine_trophies.png",
      alt: "The trophies screen of the KoalaKo app, where the user is able to view their awards and achievements.",
      width: 1125,
      height: 2436,
      group: "refine_feedback",
    },
    refine_post_activity: {
      name: "refine_post_activity",
      src: "/assets/images/koalako/refine/refine_post_activity.png",
      alt: "The post-activity screen of the KoalaKo app, where the user is able to rate their experience and leave feedback if they want.",
      width: 1125,
      height: 2436,
      group: "refine_feedback",
    },
    refresh_activities_feed_before: {
      name: "refresh_activities_feed_before",
      src: "/assets/images/koalako/refine/refresh_activities_feed_before.png",
      alt: "A screenshot of an earlier version of the KoalaKo activities feed page, showing a list of activities that parents can do with their child. Each activity has a title, description, tags, and can be tapped to view more information.",
      width: 1125,
      height: 2436,
      group: "refresh_activities",
    },
    refresh_activities_feed_after: {
      name: "refresh_activities_feed_after",
      src: "/assets/images/koalako/refine/refresh_activities_feed_after.png",
      alt: "A screenshot of the final design for the KoalaKo activities page, with visual improvements to typography, colors, and layout.",
      width: 1125,
      height: 2436,
      group: "refresh_activities",
    },
    refresh_activities_listing_before: {
      name: "refresh_activities_listing_before",
      src: "/assets/images/koalako/refine/refresh_activities_listing_before.png",
      alt: "A screenshot of an earlier version of the activities listing page on the KoalaKo app.  This page is reached by tapping an activity listing on the main activity feed, and contains expanded details about the activity, as well as a suggested local spot to play.",
      width: 1125,
      height: 2436,
      group: "refresh_activitiy_listing",
    },
    refresh_activities_listing_after: {
      name: "refresh_activities_listing_after",
      src: "/assets/images/koalako/refine/refresh_activities_listing_after.png",
      alt: "A screenshot of the final version of the activities listing page on the KoalaKo app, with visual improvements to typography, colors, and layout.",
      width: 1125,
      height: 2436,
      group: "refresh_activitiy_listing",
    },
    solution_mockup_interests: {
      name: "solution_mockup_interests",
      src: "/assets/images/koalako/solution/solution_mockup_interests.png",
      alt: "A high fidelity mockup of the interests selection screen in the KoalaKo app, where at sign-up a parent is able to select a handful of their child's interests to help with tailored suggestions.",
      width: 1125,
      height: 2436,
      group: "solution_mockup_1",
    },
    solution_mockup_activities: {
      name: "solution_mockup_activities",
      src: "/assets/images/koalako/solution/solution_mockup_activities.png",
      alt: "A high fidelity mockup of the activities screen in the KoalaKo app, where users can browse a feed of recommended activities for their kids.",
      width: 1125,
      height: 2436,
      group: "solution_mockup_1",
    },

    solution_mockup_location_browse: {
      name: "solution_mockup_location_browse",
      src: "/assets/images/koalako/solution/solution_mockup_location_browse.png",
      ...
      width: 1125,
      height: 2436,
      group: "solution_mockup_2",
    },
    solution_mockup_location_listing: {
      name: "solution_mockup_location_listing",
      src: "/assets/images/koalako/solution/solution_mockup_location_listing.png",
    ...
    solution_mockup_setup: {
      ...
      width: 1125,
      height: 2436,
      group: "solution_mockup_3",
    },
    solution_mockup_skip: {
      name: "solution_mockup_skip",
      src: "/assets/images/koalako/solution/solution_mockup_skip.png",
    ...
    submission_screen_1_intro: {
      name: "submission_screen_1_intro",
      src: "/assets/images/koalako/submission/submission_screen_1_intro.png",
      ...
      width: 1125,
      height: 2436,
      group: "koalako_submission",
    },
    submission_screen_2_interests: {
      name: "submission_screen_2_interests",
      src: "/assets/images/koalako/submission/submission_screen_2_interests.png",
    ...
    submission_screen_3_activity_browse: {
      name: "submission_screen_3_activity_browse",
      src: "/assets/images/koalako/submission/submission_screen_3_activity_browse.png",
    ...
    submission_screen_4_location_browse: {
      name: "submission_screen_4_location_browse",
    ...
    submission_screen_5_location_listing: {
      name: "submission_screen_5_location_listing",
      src: "/assets/images/koalako/submission/submission_screen_5_location_listing.png",
      alt: "A screenshot of a location listing within the KoalaKo app, where once a user has tapped on a location they are able to view info regarding suggested activities, and reviews from other users",
      width: 1125,
      height: 2436,
      group: "koalako_submission",
    },
    submission_screen_6_activity_listing: {
      name: "submission_screen_6_activity_listing",
    ...
    submission_screen_7_post_activity: {
      name: "submission_screen_7_post_activity",
    ...
    submission_screen_8_trophy_case: {
      name: "submission_screen_8_trophy_case",
    ...
    submission_screen_9_child_profile: {
      name: "submission_screen_9_child_profile",
    ...
    submission_screen_10_statistics: {
      name: "submission_screen_10_statistics",
