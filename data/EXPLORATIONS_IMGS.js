...
const EXPLORATIONS_IMGS = processImages(
  {
    ...
    virtual_pangea_temp: {
      ...
      tools: ["HTML/CSS/JS"],
      title: "",
      description: ["As Virtual Pangea's UX Engineer, I was tasked with salvaging our outsourced website.  The product we were delivered was subpar, and left us well behind schedule.", "I implemented necessities like navigation, and responsivity. Content blocks and features that were missing or broken, were rebuilt.", "To the eye of the user, I added animations and passed over styling and typesetting.  Making a far more digestible experience. While under the hood, I added proper SEO, and optimized performance."],
      study: "",
      //   group: '',
      //   index: 0,
    },
    crypic_pixel_video_01: {
      ...
      title: "Website Demo",
      description: ["As the UX Engineer at Virtual Pangea, I developed the website for our sister company, Cryptic Pixel.  It's a fun, vibrant online identity, with a look like no other.", "My front-end skills were constantly challenged by the unique, tactile UI elements. In parallel, my abilities in UX were honed through an open dialogue between myself and our talented designer.", "I actively influenced, and extrapolated from mockups through a mutual exchange of feedback and ideas. Allowing me to elevate the look and feel of the interactions wherever possible, rather than simply taking the designs from A to B.", "Fully responsive, parity between major browsers, and accessible to all users."],
      group: "cryptic_pixel",
    ...
    discog_calc_video_01_example_brockhampton: {
      ...
      title: "Demo 1",
      description: [`"How much would it cost to own an artist's entire physical discography?"  To music collectors like myself, this can be a common question, Which is why I built the "Discography Calculator".`, `This handy tool was designed and built with enthusiasts and record store owners in mind.  It aims to help make purchasing plans, set goals for your collection, or just to satisfy curiosity.`, `Powered by Node.js, and the Discogs API, the site uses live data straight from marketplace listings.  Enter the name of any artist, and receive a grand sum for each of their physical releases, the cost per album, and their percentage of the total cost.`],
      group: "discog_calc",
    ...
    killer_mike_motion_graphic: {
      ...
      description: ["I set out to create a kinetic typography animation that enhanced an audio clip without overshadowing its core message.", "I refined the visual style through iteration, storyboarding, and embracing feedback. Each shot features engaging graphics that complement the tone and words spoken.", "This project pushed my skills in After Effects at every turn.  Thankfully, my passion for the subject and medium kept me motivated throughout."],
      //   group: '',
      //   index: 0,
    },
    makeright_presentation_video: {
      ...
      description: ["For my undergraduate capstone, I designed a service that connects owners of 3D printers, to customers in need. ", "To help convey the concept and how it works, I created this short presentation video.  Motion graphics, a concise script, and informative visuals turn this multi-faceted project, into something fun and digestible.", "Check out my MakeRight case study for an in-depth look at the design process, and final product."],
      study: "makeright",
      //   group: '',
      //   index: 0,
    },
    ...
    koalako_final_01: {
      ...
      title: "Statistics",
      description: ["KoalaKo assists parents in discovering fun, and unique games for their kids.  Leading a team of 4 designers, our goal was to find a digital-age solution for fostering creativity.", "Parents can explore numerous age-appropriate activities and play areas.  Choosing to track their child's creative growth enables tailored activity suggestions.  These diversify their play experience, and help build their toolkit of creative expression.", "View my KoalaKo case study for a deeper understanding of the design, and final product!"],
      study: "koalako",
    ...
    customer_screen_06: {
      ...
      description: ["For my undergrad capstone, I developed a gig-economy-based platform to connect 3D printer owners with customers in need. ", "Makeright dismantles the steep barriers of cost and technical knowledge that stand in the way of mass adoption.  It enables printer owners to monetize their skills, while giving customers easy access to a previously unreachable technology. ", "Check out my MakeRight case study for an in-depth look at the design process, and final product."],
      study: "makeright",
